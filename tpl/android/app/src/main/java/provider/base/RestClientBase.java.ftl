 ...
 * You should edit RestClient class instead of this one or you will lose all your modifications.</i></b>
 *
 */
public class RestClientBase {
     ...
     *     you are going to be using.
     */
    public RestClientBase(String serviceName, int port, String scheme) {
